        ...
        <nav>
           <div id="menuToggle">
                ...
                <ul id="menu">
                    ...
                    <a href="/testt/views/cart/cartPage.jsp"><li>장바구니</li></a>
                    ...
                    <ul class="toggle-business">
                        <a href="/testt/cupperview?page=1&category=비즈니스"><li>비즈니스 전체보기</li></a>
                    ...
                    <ul class="toggle-programming">
                        <a href="/testt/pcaupview?page=1&category=프로그래밍"><li>프로그래밍 전체보기</li></a>
                        <a href="/testt/pccourse?page=1&category=프로그래밍 이론"><li>프로그래밍 이론</li></a>
                        <a href="/testt/pccourse?page=1&category=프로그래밍 언어"><li>프로그래밍 언어</li></a>
                        <a href="/testt/pccourse?page=1&category=웹"><li>웹</li></a>
                        <a href="/testt/pccourse?page=1&category=모바일"><li>모바일</li></a>
                        <a href="/testt/pccourse?page=1&category=게임"><li>게임</li></a>
                        <a href="/testt/pccourse?page=1&category=DB"><li>DB</li></a>
                        <a href="/testt/pccourse?page=1&category=데이터과학"><li>데이터과학</li></a>
                    </ul>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="dropdown-content">
                            ...
                            <div class="dropdown-contentSub">
                                <div class="is-visible drop-business">
                                    <a href="/testt/cupperview?page=1&category=비즈니스">비즈니스 전체보기</a>
                                ...
                                <div class="drop-programming">
                                    <a href="/testt/pcaupview?page=1&category=프로그래밍">프로그래밍 전체보기</a>
                       				<a href="/testt/pccourse?page=1&category=프로그래밍 이론">프로그래밍 이론</a>
                        			<a href="/testt/pccourse?page=1&category=프로그래밍 언어">프로그래밍 언어</a>
                        			<a href="/testt/pccourse?page=1&category=웹">웹</a>
                        			<a href="/testt/pccourse?page=1&category=모바일">모바일</a>
                        			<a href="/testt/pccourse?page=1&category=게임">게임</a>
                        			<a href="/testt/pccourse?page=1&category=DB">DB</a>
                        			<a href="/testt/pccourse?page=1&category=데이터과학">데이터과학</a> 
                                </div>
                            </div>
                        </div>
                    </div>
