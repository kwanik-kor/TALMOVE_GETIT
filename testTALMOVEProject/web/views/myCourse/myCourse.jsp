<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="course.model.vo.Course, java.util.ArrayList, review.model.vo.Review"%>
<%
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 col-md-4 col-lg-3 mt-4">
				<div class="card">
					<a href="/testt/views/coursePlay/coursePlay.jsp"> <img
						class="card-img-top" src="https://picsum.photos/200/150/?random">
					</a>
					...
					<div class="card-footer bg-white">
						...
						<div class="meta" id="open-review-box1" style="text-align: right;"
							data-toggle="modal" data-target="#exampleModal1">
							<a href="#"><span class="text">등급 남기기</span></a>
						</div>
						<div class="meta" id="open-review-box2" style="text-align: right;"
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<!-- 리뷰 폼  -->
							<form
								action="/testt/creview?courseNo=<%=course.getCourseNo()%>&userNo=<%=loginUser.getUserNo()%>"
								...
								<div id=rating align=center style="margin-top: 10px;">
									<span> <img id=image1 onmouseover=show(1)
										...
										src="testt/resources/img/star-off.png"> <img id=image2
										onmouseover=show(2) onclick=mark(2) onmouseout=noshow(2)
										src="testt/resources/img/star-off.png"> <img id=image3
										onmouseover=show(3) onclick=mark(3) onmouseout=noshow(3)
										src="testt/resources/img/star-off.png"> <img id=image4
										onmouseover=show(4) onclick=mark(4) onmouseout=noshow(4)
										src="testt/resources/img/star-off.png"> <img id=image5
								...
								<div class="text-center" style="margin-top: 10px;">
									<div>
										<textarea class="content" id="content" name="content"
											cols="50" rows="8" placeholder="리뷰를 입력해 주세요."></textarea>
									</div>
									<div>
										<button class="btn btn-primary save" type="submit"
											style="margin-top: 10px;">저장 및 종료</button>
										<input type="hidden" name="cno"	value="<%=course.getCourseNo()%>">
			...
			<div class="modal fade" id="exampleModal2" tabindex="-1"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h6 class="modal-title" id="exampleModalLabel">내가 남긴 리뷰</h6>
							<button type="button" class="close" data-dismiss="modal"
								aria-label="Close">
								<span aria-hidden="true">×</span>
							</button>
						</div>
						<form action="/testt/crdelete" method="post">
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-outline-primary"
									...
									data-target="#exampleModal1">수정하기</button>
