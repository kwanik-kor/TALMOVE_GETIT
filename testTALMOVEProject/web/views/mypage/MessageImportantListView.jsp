...
<div id="pannel">
  ...
  <!--  <div id="pannel" >
      <div id="upImgDiv">
            <img class="pfimg" src="/testt/views/mypage/images/absence_08.jpg">
      </div>
      <div id="titleName">
         <p id="teacherPage" ><span id="names">Dave</span> 님의 마이페이지</p>
      </div>
   </div>
         <div id="page-wrapper">
           사이드바
           <div id="sidebar-wrapper">
             <ul class="sidebar-nav">
               <li><a href="#">프로필</a></li>
               <li class="menu"><a href="/test1/views/board/talmove090602.jsp">메시지</a>
                     <ul class="maghidemenu">
                         <li><a href="/testt/views/mypage/MessageNewSendView.jsp">새 메시지</a></li>
                         <li><a href="/testt/views/mypage/MessageListView.jsp">모든 메시지</a></li>
                         <li><a href="/testt/views/mypage/MessageImportantListView.jsp">중요 메시지</a></li>
